...
fswatch monitors the Bear SQLite database using --monitor=poll_monitor
A Launch Agent keeps fswatch running in the background, starting automatically at login
On every change, bear_sync.sh runs:
